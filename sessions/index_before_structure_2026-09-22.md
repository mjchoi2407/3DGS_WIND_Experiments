...
- **GPU 셀프 접촉 v10 실패 프레임 복구:** 원본 code2 재현, cycles6은 실패·dt절반128단계 통과. 실제 GPU 자동 복구까지 통과·관련54회귀·세 씬 준비. 실패 비용 포함·장기/5070 미검증 구분. [결과·명령](../R1_teacher_velocity_reset/self_contact/frame112_recovery.md).

- **셀프 접촉 비용:** 과거 공유 부하 배수는 원본 보존·순수 접촉 비용으로 미채택. 후속 사용자 유휴 확인 후135측정 프레임·7,164단계 승인과 새 비용 비교 완료. [비용·한계](../R1_teacher_velocity_reset/self_contact/idle_performance.md).

- **셀프 접촉 강도 비교:** 계수1,000/10,000의 v1 기하 미인증 원본은 보존하고 v2 추가 인증으로 해결. 약한100의 고속 실패 보존·proxy 응답 수렴 미완료. [인계](2026-09-22_02_self_contact.md).
