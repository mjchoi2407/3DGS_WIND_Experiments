...
report={'input_sha256':hashlib.sha256(source.read_bytes()).hexdigest(),'source_sha256':hashlib.sha256((out/'source.zip').read_bytes()).hexdigest(),'environment':environment,'input_time_s':state.time_s,'dt_s':h,'stages':6,'substeps':1,'multiplier':256,'training_eligible':False}
