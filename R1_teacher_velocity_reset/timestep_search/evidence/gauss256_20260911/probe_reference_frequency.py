...
source=base/'20260911_gauss256_stage4_v1/endpoint.npz'
with np.load(source) as z:u0=z['u_hi'].astype(np.longdouble)+z['u_lo'].astype(np.longdouble)
ref=base/'20260911_gauss256_followup_gaussref4_v1/step3/endpoint.npz'
def velocity(path):
...
'gauss6_ref2':base/'20260911_gauss256_followup_gaussref2_v1/step1/endpoint.npz',
'newmark128':base/'20260911_gauss256_followup_refine128_v1/sub128_step127.npz'}
rows={}
