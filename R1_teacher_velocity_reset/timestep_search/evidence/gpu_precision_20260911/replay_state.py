...
again,_=s.step(initial,force,dt)
r['same_process_u_exact']=bool(np.array_equal(again.displacement_m,result.displacement_m));r['same_process_v_exact']=bool(np.array_equal(again.velocity_m_s,result.velocity_m_s))
print(json.dumps(r),flush=True)
assert r['u_exact'] and r['v_exact'] and r['time_exact']
