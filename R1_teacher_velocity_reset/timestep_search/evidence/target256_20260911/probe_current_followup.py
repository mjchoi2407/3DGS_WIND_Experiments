"""256배·restart240으로 큰 변형 시험 이후4개 frame을 검산한다."""
...
checkpoint=p.parent/'20260911_target256_current_matrix_v2/restart240_step0.npz'
